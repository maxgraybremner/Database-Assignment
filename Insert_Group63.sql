...
INSERT INTO TRIP (DriverLicenseNum, OfficialID, LanguageCode, PickUpLocID, DropOffLocID, VIN, StartTimeIntended, EndTimeIntended, StartTimeActual, EndTimeActual, StartOdometerKM, EndOdometerKM) 
    VALUES('WFU6TKIW97RQ', 'ND9N4T8L', 'en', 8, 9, 'WBS3U920X0J966829', '2023-02-08 09:00:00', '2023-02-08 11:00:00', '2023-02-08 09:15:25', '2023-02-08 11:45:00', 24054, 24084),
    ('V3R9FM7PX5RR', '9KY8GJFP', 'it', 14, 12, 'JHDFM8JR1XXX10152', '2023-02-10 05:00:00', '2023-02-10 08:00:00', '2023-02-10 05:12:00', '2023-02-10 08:05:20', 1257458, 1257568),
    ('T6YH234GJNU7', 'T5YMTFPG', 'fr', 12, 13, 'KMHH351EMNU176947', '2023-02-08 09:00:00', '2023-02-08 11:00:00', '2023-02-08 09:46:13', '2023-02-08 11:05:30', 32615, 32648),
    ('UZ4B2RHA6U62', 'F9336KVE', 'ar', 10, 8, 'WBA7T2C02LCD06343', '2023-02-12 09:00:00', '2023-02-12 10:30:00', '2023-02-12 09:23:01', '2023-02-12 17:47:05', 5984, 6034),
    ('OUW35JY1U8BW', 'ND9N4T8L', 'es', 9, 14, 'MR0HA3CD400355234', '2023-02-08 07:00:00', '2023-02-08 11:00:00', '2023-02-08 09:12:12', '2023-02-08 11:42:10', 84569, 84648);

    ERROR 1452 (23000): Cannot add or update a child row: a foreign key constraint fails 
    (`ctsdb`.`trip`, CONSTRAINT `trip_ibfk_4` FOREIGN KEY (`PickUpLocID`) REFERENCES `location` (`LocationID`))